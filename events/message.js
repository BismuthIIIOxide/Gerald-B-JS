...
module.exports = async (bot, message) => {
    ...
    if (message.channel.id === "851855270685835264" || message.channel.id === "702972566419144875"){
        ...
        if (msg.search(/this/i) != 1){
            bot.channels.get(message.channel.id).send("https://media.discordapp.net/attachments/925876223878508694/942822275189719070/1B0F18A8-E03C-4BB5-AD3C-7A7486BA3E9")
        }
